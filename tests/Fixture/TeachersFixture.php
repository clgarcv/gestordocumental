...
class TeachersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'apellidos' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-01-19 16:22:12',
            'modified' => '2017-01-19 16:22:12'
        ],
    ];
}
